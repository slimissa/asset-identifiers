...
|---------|------|-------------|-------|-------------|
| 1.2.1 | 2026-08-14 | 50 | 292 | Initial release |
```
...
| 1.2.1 Added | Everything new in the initial release |
| 1.2.1 Changed | Modifications to existing files |
| 1.2.1 Fixed | All bugs that were found and fixed |
| 1.2.1 Removed | Items that were deleted |
