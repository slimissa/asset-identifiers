...
func main() {
    ...
    fmt.Println("Version:", registry.Version())    // 1.1.0
    ...
    fmt.Println(registry)  // Asset Identifier Registry v1.1.0 (50 instruments)
}
```
...
// Output: Asset Identifier Registry v1.1.0 (50 instruments)
```
